...
export default function ResetPasswordPage() {
  ...
  // Supabase akan otomatis login user jika link valid, jadi tidak perlu ambil token manual
  useEffect(() => {
    // Jika user sudah login (setelah klik link email), biarkan user reset password
